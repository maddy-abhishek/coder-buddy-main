...
class TestResult(BaseModel):
    passed: bool = Field(description="Whether the tests passed")
    output: str = Field(description="Test output (stdout+stderr)")
    details: Optional[dict] = Field(None, description="Additional details like test counts, failures, etc.")
...
class CoderState(BaseModel):
    ...
    test_results: Optional[TestResult] = Field(None, description="Results of running tests after implementation")